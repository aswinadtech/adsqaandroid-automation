...
public class AndroidKOREAPrivacyTest extends TwcIosBaseTest {
	// private static final MobileAutomationLogger LOGGER = new
	// MobileAutomationLogger(KOREAFunctionalEULaunchTests.class);
	private static final String CONFIG_FILE_PATH = "enableKOREA.config";
	...
	public void beforeClass() {
		System.out.println("****** KOREA Privacy Test Started");
		logStep("****** KOREA Privacy Test Started");
		this.configFile = this.rewriteRuleToEnableKOREA(CONFIG_FILE_PATH);
	...
	public void afterClass() throws Exception {
		...
		System.out.println("****** KOREA Privacy Test Ended");
		logStep("****** KOREA Privacy Test Ended");
		System.out.println("==============================================");
	}
	...
	public void downloadAndInstallApp_for_KOREA() throws Exception {
		System.out.println("==============================================");
	...
	@Test(priority = 0)
	@Description("Enable Preconditions for KOREA")
	public void preConditionsTest_for_KOREA() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** PreConditions For KOREA test case Started");
		logStep("****** PreConditions For KOREA test case Started");
		// Preconditions
		Functions.capabilities();
		Functions.Appium_Autostart();
	...
	public void Verify_Lotame_Call_for_KOREA() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_LocationWFXTriggers_Call__for_KOREA() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_WFXTriggers_Callfor_KOREA() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_for_KOREA() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Criteo_SDK_config_app_Call_for_KOREA() throws Exception {
		System.out.println("==============================================");
