...
public class CONNECTICUTPrivacyTest extends TwcIosBaseTest {
	// private static final MobileAutomationLogger LOGGER = new
	// MobileAutomationLogger(GDPRFunctionalEULaunchTests.class);
	
	private static final String CONNECTICUT_CONFIG_FILE_PATH = "enableCONNECTICUT.config";
	...
	public void beforeClass() {
		System.out.println("****** CONNECTICUT Privacy Test Started");
		logStep("****** CONNECTICUT Privacy Test Started");
		this.configFile = this.rewriteRuleToEnableCONNECTICUT(CONNECTICUT_CONFIG_FILE_PATH);
		proxy = new CharlesProxy("localhost", 8111, CONNECTICUT_CONFIG_FILE_PATH);
	...
	public void afterClass() throws Exception {
		...
		System.out.println("****** CONNECTICUT Privacy Test Ended");
		logStep("****** CONNECTICUT Privacy Test Ended");
		System.out.println("==============================================");
	}
...
/*	@Test(priority = -1)
	...
	public void downloadAndInstallApp_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	@Test(priority = 0)
	@Description("Enable Preconditions for CONNECTICUT")
	public void preConditionsTest_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** PreConditions For CONNECTICUT test case Started");
		logStep("****** PreConditions For CONNECTICUT test case Started");
		// Preconditions
		Utils.getiPhoneUDID();
		Utils.getiOSVersion();
		Functions.capabilities();
	 ...
	 */
	  ...
	  verify_enabling_Privacy_optin_for_CONNECTICUT() throws Exception {
	  System.out.println("==============================================");
	  System.out.
	...
	public void navigate_To_Feed_Cards_when_Privacy_optin_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void validate_NextGen_IM_Adcall_sod_val_privacy_optin_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void verify_Hourly_details_call_sod_val_privacy_optin_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void verify_Daily_details_call_sod_val_privacy_optin_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Amazon_Call_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Lotame_call_privacy_optin_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_LocationWFXTriggers_Call_privacy_optin_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_WFXTriggers_Call_privacy_optin_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void validate_NextGen_IM_call_rdp_val_privacy_optin_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_privacy_optin_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
		System.out
	...
	public void Verify_Criteo_SDK_config_app_Call_privacy_optin_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
		System.out.println(
	...
	public void derive_VideoCall_IU_when_Privacy_optin_for_CONNECTICUT() throws Exception {

		System.out.println("==============================================");
		System.out.println("****** Deriving VideoCall For CONNECTICUT when privacy optin");
		logStep("****** Deriving VideoCall For CONNECTICUT when privacy optin");
		hmTab.clickonHomeTab();
		hmTab.clickonHomeTab();
		Functions.archive_folder("Charles");
		proxy.clearCharlesSession();
	...
	public void verify_PrerollAd_call_sod_val_privacy_optin_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void validate_PrerollVideo_call_rdp_val_privacy_optin_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void verify_enabling_Privacy_optout_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void navigate_To_Feed_Cards_when_Privacy_optout_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void validate_NextGen_IM_Adcall_sod_val_privacy_optout_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
		// Functions.retryclear();
	...
	public void verify_Hourly_details_call_sod_val_privacy_optout_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void verify_Daily_details_call_sod_val_privacy_optout_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Amazon_Call_privacy_optout_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Lotame_Call_privacy_optout_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_LocationWFXTriggers_Call_privacy_optout_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_WFXTriggers_Call_privacy_optout_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void validate_NextGen_IM_call_rdp_val_privacy_optout_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_privacy_optout_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
		System.out.println(
	...
	public void Verify_Criteo_SDK_config_app_Call_privacy_optout_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
		System.out.println(
	...
	public void derive_VideoCall_IU_when_Privacy_optout_for_CONNECTICUT() throws Exception {

		System.out.println("==============================================");
		System.out.println("****** Deriving VideoCall For CONNECTICUT when privacy optout");
		logStep("****** Deriving VideoCall For CONNECTICUT when privacy optout");
		hmTab.clickonHomeTab();
		hmTab.clickonHomeTab();
		Functions.archive_folder("Charles");
		proxy.clearCharlesSession();
	...
	public void verify_PrerollAd_call_sod_val_privacy_optout_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
	...
	public void validate_PrerollVideo_call_rdp_val_privacy_optout_for_CONNECTICUT() throws Exception {
		System.out.println("==============================================");
