...
public class CriteoAndAmazonBidTest extends TwcIosBaseTest {
	...
	public void Verify_Hourly1_Big_adcall_amazon_bid_id() throws Exception {
		...
		Utils.validate_aax_bid_value_with_gampad_bid_value("Smoke", "Hourly1", true, true, 1);
	}
	...
	public void Verify_Hourly2_Big_adcall_amazon_bid_id() throws Exception {
		...
		Utils.validate_aax_bid_value_with_gampad_bid_value("Smoke", "Hourly2", true, true, 2);
	}
	...
	public void Verify_Hourly3_Big_adcall_amazon_bid_id() throws Exception {
		...
		Utils.validate_aax_bid_value_with_gampad_bid_value("Smoke", "Hourly3", true, true, 3);
	}
